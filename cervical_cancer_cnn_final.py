...
def evaluate_model(model, test_loader, device='cuda'):
    checkpoint = torch.load('best_cervical_model_final.pth')
...
def plot_training_history(train_losses, val_losses, train_accs, val_accs):
    ...
    print("训练历史曲线已保存为 training_history_final.png")
...
def main():
    ...
    optimizer = optim.AdamW([
        ...
        {'params': model.layer4.parameters(), 'lr': 0.0001, 'weight_decay': 1e-4},
        {'params': model.layer3.parameters(), 'lr': 0.00005, 'weight_decay': 1e-4}
    ], weight_decay=1e-4)
